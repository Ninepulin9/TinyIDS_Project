...
const Register = () => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-gray-100 px-6 py-10 sm:px-8 sm:py-16">
      {modal.open && (
      ...
      <div className="flex h-auto w-full max-w-[1380px] min-h-[680px] overflow-hidden rounded-[28px] bg-white shadow-2xl">
        {/* Left Panel - Blue Section */}
        <div className="hidden w-[46%] flex-col bg-gradient-to-br from-blue-400 to-blue-500 p-12 text-white lg:flex xl:p-14">
          <div>
        ...
        <div className="flex w-full flex-col justify-center bg-white px-8 py-10 sm:px-10 sm:py-12 lg:w-[54%] lg:px-16 lg:py-16 xl:px-20">
          <div className="mx-auto w-full max-w-[600px]">
            <div className="mb-6">
              <h2 className="text-4xl font-bold text-gray-900 sm:text-5xl xl:text-[3.25rem]">Create your TinyIDS account</h2>
              <p className="mt-3 text-base text-gray-600">Secure IoT Intrusion Detection Dashboard</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-x-5 gap-y-2 pt-2 text-sm sm:grid-cols-2">
